...
SELECT cor FROM Animais ORDER BY cor;
SELECT cor, COUNT(id) AS Total FROM Animais GROUP BY cor ORDER BY cor;
SELECT cor, SUM(peso) FROM Animais GROUP BY cor HAVING AVG(peso) > 15;
