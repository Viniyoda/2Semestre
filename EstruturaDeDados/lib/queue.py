class Queue:
    ...
    Trata-se de uma estrutura de dados linear em que a
    operação de inserção ("enqueue") ocorre no final
    (ou cauda) da estrutura, enquanto a operação de 
    remoção ("dequeue") é feita no início (cabeça).
    Em consequência, o funcionamento da fila pode ser
    ...
    def dequeue(self):
        ...
        # Remove da posição inicial (índice 0)
    ...
    def peek(self):
        ...
        # Retorna o primeiro elemento (índice 0)
